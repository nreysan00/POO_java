			...
			switch (opcion) {
				...
				case 3:
					if (rellenado) {
						...
						System.out.println("La suma de los valores de la columna "
								+columna+ " es: "+sumaColumna(matriz, columna));
					}else {
						System.out.println("Debes rellenar la matriz primero");
					}
					break;
				...
				case 6:
					if (rellenado) {
						...
						System.out.println("Debes rellenar la matiz primero");
					}
					break;
				case 7:
					salir = true;
					break;
				default:
					System.out.println("Tienes que introducir un valor entre 1 y 7");
			}
	...
	public static void rellenarMatriz(Scanner sn, int[][] matriz) {
		for (int i=0; i < matriz.length; i++) {
			for (int j=0; j < matriz[0].length; j++) {
				System.out.println("Escribe un número en la posición "+i+ " "+j);
