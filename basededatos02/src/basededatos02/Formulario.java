...
public class Formulario extends JFrame {
	private JPanel contentPane;
	  ...
	  public Formulario() {
	    ...
	    btnAlta.setBounds(23, 99, 179, 23);
	    contentPane.add(btnAlta);
	    
	    labelResultado = new JLabel("resultado");
	    labelResultado.setBounds(136, 297, 229, 14);
	    ...
	    btnConsultaPorCdigo.setBounds(23, 132, 177, 23);
	    contentPane.add(btnConsultaPorCdigo);
	    
	    tf3 = new JTextField();
	    tf3.setBounds(217, 133, 86, 20);
	    contentPane.add(tf3);
	    tf3.setColumns(10);
	    ...
	    btnNewButton.setBounds(23, 170, 177, 23);
	    ...
	    btnNewButton_1.setBounds(23, 204, 179, 23);
